...
# Test
function debug() {
    ./run_stuff.sh -P ${scr_prefix} -n debug -r debug-memory -S ${seed} -T mnli -C mlp -o adam -l 1e-4 -h 1500 -D 0.2 -L 2 -H 0 -M percent_tr -B 1 -V 723 -y .2 -K 0 -p 5 -W proportional -s max -q -m -b 128 -I ${gpuid}
}
